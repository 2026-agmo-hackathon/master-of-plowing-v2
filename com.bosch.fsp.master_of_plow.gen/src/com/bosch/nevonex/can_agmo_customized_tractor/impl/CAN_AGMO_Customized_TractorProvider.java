...
/**
 * An implementation of the model object '<em><b>CAN_AGMO_Customized_TractorProvider</b></em>'.
 * @generated
 */
public class CAN_AGMO_Customized_TractorProvider extends EObjectImpl implements ICAN_AGMO_Customized_TractorProvider, IMachineProvider {
	protected EList<PropertyChangeListener> listeners;
	protected IFCALController controller;
	protected ICAN_AGMO_Customized_Tractor cAN_AGMO_Customized_Tractor;
	 ...
	 * @generated
	 */
	public CAN_AGMO_Customized_TractorProvider() {
		super();
	}

	public ICAN_AGMO_Customized_Tractor getCAN_AGMO_Customized_Tractor() {
		if (cAN_AGMO_Customized_Tractor != null && ((org.eclipse.emf.ecore.EObject) cAN_AGMO_Customized_Tractor).eIsProxy()) {
			org.eclipse.emf.ecore.InternalEObject old = (org.eclipse.emf.ecore.InternalEObject) cAN_AGMO_Customized_Tractor;
			cAN_AGMO_Customized_Tractor = (ICAN_AGMO_Customized_Tractor) eResolveProxy(old);
		}
		return cAN_AGMO_Customized_Tractor;
	}

	public ICAN_AGMO_Customized_Tractor basicGetCAN_AGMO_Customized_Tractor() {
		return cAN_AGMO_Customized_Tractor;
	}

	public void setCAN_AGMO_Customized_Tractor(ICAN_AGMO_Customized_Tractor newCAN_AGMO_Customized_Tractor) {
		cAN_AGMO_Customized_Tractor = newCAN_AGMO_Customized_Tractor;
	}

	public boolean acceptDom(String root) {
		return "can_agmo_customized_tractor".equalsIgnoreCase(root);
	}
	...
	public void createMachines(InputStream stream) throws MachineInitException {
		...
		try {
			...
			constructChildTypes(secondLevelNodeList.get(0), cAN_AGMO_Customized_Tractor, "CAN_AGMO_Customized_Tractor");
		} catch (Exception e) {
	...
	private synchronized void ensureMachineCreated() {
		if (cAN_AGMO_Customized_Tractor != null) {
			return;
		}
		setCAN_AGMO_Customized_Tractor(Can_agmo_customized_tractorFactory.eINSTANCE.createCAN_AGMO_Customized_Tractor());
		if (cAN_AGMO_Customized_Tractor != null) {
			constructChildTypes(null, cAN_AGMO_Customized_Tractor, "CAN_AGMO_Customized_Tractor");
			notifyPropertyChange("root", null, cAN_AGMO_Customized_Tractor);
		}
	}
	...
	public void constructChildTypes(Node parent, Object parentObj, String path) {
		...
		indexToObjectMap.put("CAN_AGMO_Customized_Tractor", topicObject);
		indexToObjectMap.put("can_agmo_customized_tractor", topicObject);
		indexToObjectMap.put("can_agmo_customized_tractor/0", topicObject);
	...
	protected EClass eStaticClass() {
		return Can_agmo_customized_tractorPackage.Literals.CAN_AGMO_CUSTOMIZED_TRACTOR_PROVIDER;
	}
