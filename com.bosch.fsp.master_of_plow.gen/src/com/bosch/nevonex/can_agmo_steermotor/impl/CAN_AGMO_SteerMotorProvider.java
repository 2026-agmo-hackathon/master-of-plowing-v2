...
/**
 * An implementation of the model object '<em><b>CAN_AGMO_SteerMotorProvider</b></em>'.
 * @generated
 */
public class CAN_AGMO_SteerMotorProvider extends EObjectImpl implements ICAN_AGMO_SteerMotorProvider, IMachineProvider {
	protected EList<PropertyChangeListener> listeners;
	protected IFCALController controller;
	protected ICAN_AGMO_SteerMotor cAN_AGMO_SteerMotor;
	 ...
	 * @generated
	 */
	public CAN_AGMO_SteerMotorProvider() {
		super();
	}

	public ICAN_AGMO_SteerMotor getCAN_AGMO_SteerMotor() {
		if (cAN_AGMO_SteerMotor != null && ((org.eclipse.emf.ecore.EObject) cAN_AGMO_SteerMotor).eIsProxy()) {
			org.eclipse.emf.ecore.InternalEObject old = (org.eclipse.emf.ecore.InternalEObject) cAN_AGMO_SteerMotor;
			cAN_AGMO_SteerMotor = (ICAN_AGMO_SteerMotor) eResolveProxy(old);
		}
		return cAN_AGMO_SteerMotor;
	}

	public ICAN_AGMO_SteerMotor basicGetCAN_AGMO_SteerMotor() {
		return cAN_AGMO_SteerMotor;
	}

	public void setCAN_AGMO_SteerMotor(ICAN_AGMO_SteerMotor newCAN_AGMO_SteerMotor) {
		cAN_AGMO_SteerMotor = newCAN_AGMO_SteerMotor;
	}

	public boolean acceptDom(String root) {
		return "can_agmo_steermotor".equalsIgnoreCase(root);
	}
	...
	public void createMachines(InputStream stream) throws MachineInitException {
		...
		try {
			...
			constructChildTypes(secondLevelNodeList.get(0), cAN_AGMO_SteerMotor, "CAN_AGMO_SteerMotor");
		} catch (Exception e) {
	...
	private synchronized void ensureMachineCreated() {
		if (cAN_AGMO_SteerMotor != null) {
			return;
		}
		setCAN_AGMO_SteerMotor(Can_agmo_steermotorFactory.eINSTANCE.createCAN_AGMO_SteerMotor());
		if (cAN_AGMO_SteerMotor != null) {
			constructChildTypes(null, cAN_AGMO_SteerMotor, "CAN_AGMO_SteerMotor");
			notifyPropertyChange("root", null, cAN_AGMO_SteerMotor);
		}
	}
	...
	public void constructChildTypes(Node parent, Object parentObj, String path) {
		...
		indexToObjectMap.put("CAN_AGMO_SteerMotor", topicObject);
		indexToObjectMap.put("can_agmo_steermotor", topicObject);
		indexToObjectMap.put("can_agmo_steermotor/0", topicObject);
	...
	protected EClass eStaticClass() {
		return Can_agmo_steermotorPackage.Literals.CAN_AGMO_STEER_MOTOR_PROVIDER;
	}
