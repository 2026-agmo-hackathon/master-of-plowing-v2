...
/**
 * An implementation of the model object '<em><b>ISOPGNProvider</b></em>'.
 * @generated
 */
public class ISOPGNProvider extends EObjectImpl implements IISOPGNProvider, IMachineProvider {
	protected EList<PropertyChangeListener> listeners;
	protected IFCALController controller;
	protected IISOPGN iSOPGN;
	 ...
	 * @generated
	 */
	public ISOPGNProvider() {
		super();
	}

	public IISOPGN getISOPGN() {
		if (iSOPGN != null && ((org.eclipse.emf.ecore.EObject) iSOPGN).eIsProxy()) {
			org.eclipse.emf.ecore.InternalEObject old = (org.eclipse.emf.ecore.InternalEObject) iSOPGN;
			iSOPGN = (IISOPGN) eResolveProxy(old);
		}
		return iSOPGN;
	}

	public IISOPGN basicGetISOPGN() {
		return iSOPGN;
	}

	public void setISOPGN(IISOPGN newISOPGN) {
		iSOPGN = newISOPGN;
	}

	public boolean acceptDom(String root) {
		return "isopgn".equalsIgnoreCase(root);
	}
	...
	public void createMachines(InputStream stream) throws MachineInitException {
		...
		try {
			...
			constructChildTypes(secondLevelNodeList.get(0), iSOPGN, "ISOPGN");
		} catch (Exception e) {
	...
	private synchronized void ensureMachineCreated() {
		...
		setISOPGN(IsopgnFactory.eINSTANCE.createISOPGN());
		if (iSOPGN != null) {
			constructChildTypes(null, iSOPGN, "ISOPGN");
			notifyPropertyChange("root", null, iSOPGN);
		}
	}
	...
	public void constructChildTypes(Node parent, Object parentObj, String path) {
		...
		indexToObjectMap.put("ISOPGN", topicObject);
		indexToObjectMap.put("isopgn", topicObject);
		indexToObjectMap.put("isopgn/0", topicObject);
	...
	protected EClass eStaticClass() {
		return IsopgnPackage.Literals.ISOPGN_PROVIDER;
	}
} //ISOPGNProvider
