/*
 * nevonex/cloud/ICloudDownload.cpp
...
/*PROTECTED REGION ID(ICloudDownload.cpp) START*/
...
ICloudDownload::ICloudDownload()
{
    ...
    /*PROTECTED REGION ID(ICloudDownload__ICloudDownload) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
...
ICloudDownload::~ICloudDownload()
{
    ...
    /*PROTECTED REGION ID(ICloudDownload__Destructor) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
